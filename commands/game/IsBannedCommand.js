...
module.exports = {
	...
	category: 'game',
    rolesRequired: [],
	description: 'checks the ban status ',
	timeout: 1000,
    ...
    let username = args[0];
    if(!username) {
        return message.channel.send(client.embed("No Username Supplied", `You didn't supply a username for me to check ban status on`))
    }
